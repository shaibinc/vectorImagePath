...
public class FileUtils {
    ...
    public static ArrayList<File> getFilePaths(Context context) {
        ArrayList<File> filePaths = new ArrayList<File>();

        File[] listFiles = new File(context.getFilesDir() + "/" + FILE_DIR + "/").listFiles();
        ...
        if (listFiles != null) {
            ...
            filePaths = new ArrayList<>(Arrays.asList(listFiles));
